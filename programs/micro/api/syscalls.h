...
#define ECALL_MULTIPROCESS   (GAME_API_BASE+10)
#define ECALL_MULTIPROCESS_FORK  (GAME_API_BASE+11)
#define ECALL_MULTIPROCESS_WAIT  (GAME_API_BASE+12)
#define ECALL_GAME_EXIT      (GAME_API_BASE+13)
